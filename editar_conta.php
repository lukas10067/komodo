...
<body>
	<div id="loading">
		<div id="cor"></div>
		<p>Configurando novas edições ...</p>
	</div>
	<p id="aviso">Atenção, as fotos serão carregadas assim que as alterações forem Salvas</p>
	...
	<form method="POST" name="editar" id="editar">
		...
		<input type="submit" id="insc" name="editarConta" value="Salvar alterações" />
	</form>
