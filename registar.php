<?php
	...
	if (isset($_POST["registar"])) {
		...
		if (mysql_num_rows($verificar)>0) {
			...
			echo '<h3 id="erro">É necessário escrever uma Senha!</h3>';
		}elseif ($_POST["password"]!=$rep_password) {
			echo '<h3 id="erro">As Senhas não coincidem!</h3>';
		}else{
...
<body>
	...
	<form id="registar" method="POST">
		...
		<input type="password" name="rep_password" placeholder="Repetir Senha" />
